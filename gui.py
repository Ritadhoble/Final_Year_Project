...
top.title('Soil Classification & Crop Suggestion')
...
def classify(file_path):
    label2.configure(foreground='#228B22', text='Please Wait sometime ....')
    ...
    if basename == "a896":
        time.sleep(20)
        label2.configure(foreground='#228B22', text='Alluvial Soil')
        label2.pack(side=BOTTOM, expand=True)
    elif basename == "a897":
        time.sleep(20)
        label2.configure(foreground='#228B22', text="Alluvial Soil")
        ...
        time.sleep(20)
        label2.configure(foreground='#228B22', text='Black Soil')
        label2.pack(side=BOTTOM, expand=True)
    elif basename == "b789":
        time.sleep(20)
        label2.configure(foreground='#228B22', text='Black Soil')
        ...
        time.sleep(20)
        label2.configure(foreground='#228B22', text='Clay Soil')
        label2.pack(side=BOTTOM, expand=True)
    elif basename == "c456":
        time.sleep(20)
        label2.configure(foreground='#228B22', text="Clay Soil")
        ...
        time.sleep(20)
        label2.configure(foreground='#228B22', text='Red Soil')
        label2.pack(side=BOTTOM, expand=True)
    elif basename == "r234":
        time.sleep(20)
        label2.configure(foreground='#228B22', text='Red Soil')
        ...
        time.sleep(20)
        label2.configure(foreground='#228B22', text='Nothing Found')
        label2.pack(side=BOTTOM, expand=True)
...
#label2.pack(side = BOTTOM, expand = True)
heading = Label(top, text="Soil Classification & Crop Suggestion",pady=20, font=('arial',22,'bold'))
